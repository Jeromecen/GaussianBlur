...
// 3.合理使用GPU Shader可以有效的提高图形程序性能，运用GPU强大的并行大量数据计算能力
// 简单随意测试了下CPU降低了大概10%。
...
bool Setup()
{
	...
	//BlurTexEffect->SetFloatArray(/*filterHandle*/"ArrayGaussianFilter", g_BlurFilter.GaussianFilter3, 9);
